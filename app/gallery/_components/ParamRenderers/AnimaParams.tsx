// app/gallery/_components/ParamRenderers/AnimaParams.tsx

import { AnimaParams } from '../../types';

interface AnimaParamsRendererProps {
  params: AnimaParams;
}

export default function AnimaParamsRenderer({ params: p }: AnimaParamsRendererProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 pt-1">
        ...
        <div>
          <span className="text-secondary text-sm">CFG：</span>
          <span className="text-foreground text-sm ml-1">{p.cfg}</span>
        </div>
        <div>
